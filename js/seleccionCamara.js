...
var forma3 = document.getElementById("forma3"),
    ...
    nombreCamara = document.getElementById("nombreCamara"),
    colextF = document.getElementById("colextF"),
    aspersores = document.getElementById("aspersores"),
    camara = document.getElementsByName("camara"),
    opcionDesplegable = document.getElementById("selectAsper"),
    camaraFinal = document.getElementById("camaraFinal"),
    infoPago =document.getElementById("infoPago");
    
    forma3.addEventListener("change", cambioCamara, false);
    opcionDesplegable.addEventListener("change", cambioCamara, false);

function cambioCamara(evento){
